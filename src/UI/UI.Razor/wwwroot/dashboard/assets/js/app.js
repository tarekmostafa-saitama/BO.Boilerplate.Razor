!(function () {
                        ...
                        ? (document.getElementById("header-lang-img").src = "/dashboard/assets/images/flags/italy.svg")
                            ...
                            ? (document.getElementById("header-lang-img").src = "/dashboard/assets/images/flags/russia.svg")
                                ...
                                ? (document.getElementById("header-lang-img").src = "/dashboard/assets/images/flags/china.svg")
                                    ...
                                    : "ar" == e && (document.getElementById("header-lang-img").src = "/dashboard/assets/images/flags/ae.svg"),
            ...
            e =
                (e < 1025 && 767 < e
                    ? (document.body.classList.remove("twocolumn-panel"),
                        ...
                        "vertical" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"),
                        "semibox" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"),
                        document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.add("open"))
                    : 1025 <= e
                        ? (document.body.classList.remove("twocolumn-panel"),
                            "twocolumn" == localStorage.getItem("data-layout") &&
                            (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), i(), u(), s()),
                            "vertical" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size")),
                            "semibox" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size")),
                            document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.remove("open"))
                        : e <= 767 &&
                        (document.body.classList.remove("vertical-sidebar-enable"),
                            document.body.classList.add("twocolumn-panel"),
                            "twocolumn" == localStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "vertical"), y("vertical"), s()),
                            "horizontal" != localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "lg"),
        ...
        if (e == e) {
            switch (e["data-layout"]) {
                ...
                case "semibox":
                    ...
                    break;
                default:
                    "vertical" == localStorage.getItem("data-layout") && localStorage.getItem("data-layout")
                        ? (T("data-layout", "vertical"), localStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), y("vertical"), s())
                        : "horizontal" == localStorage.getItem("data-layout")
                            ? (T("data-layout", "horizontal"), localStorage.setItem("data-layout", "horizontal"), document.documentElement.setAttribute("data-layout", "horizontal"), y("horizontal"))
                            : "twocolumn" == localStorage.getItem("data-layout")
                                ? (T("data-layout", "twocolumn"), localStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn"), y("twocolumn"))
                                : "semibox" == localStorage.getItem("data-layout") && (T("data-layout", "semibox"), localStorage.setItem("data-layout", "semibox"), document.documentElement.setAttribute("data-layout", "semibox"), y("semibox"));
            }
            ...
            ("hidden" === e["data-sidebar-visibility"]
                ? (T("data-sidebar-visibility", "hidden"), localStorage.setItem("data-sidebar-visibility", "hidden"), document.documentElement.setAttribute("data-sidebar-visibility", "hidden"))
                : (T("data-sidebar-visibility", "show"), localStorage.setItem("data-sidebar-visibility", "show"), document.documentElement.setAttribute("data-sidebar-visibility", "show")),
                e["data-layout-style"])
            ) {
                case "default":
            ...
            switch (e["data-sidebar-size"]) {
                ...
                default:
                    "sm" == localStorage.getItem("data-sidebar-size")
                        ? (document.documentElement.setAttribute("data-sidebar-size", "sm"), T("data-sidebar-size", "sm"), localStorage.setItem("data-sidebar-size", "sm"))
                        : "md" == localStorage.getItem("data-sidebar-size")
                            ? (document.documentElement.setAttribute("data-sidebar-size", "md"), T("data-sidebar-size", "md"), localStorage.setItem("data-sidebar-size", "md"))
                            : "sm-hover" == localStorage.getItem("data-sidebar-size")
                                ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), T("data-sidebar-size", "sm-hover"), localStorage.setItem("data-sidebar-size", "sm-hover"))
                                : (document.documentElement.setAttribute("data-sidebar-size", "lg"), T("data-sidebar-size", "lg"), localStorage.setItem("data-sidebar-size", "lg"));
            }
            switch (e["data-bs-theme"]) {
                ...
                case "dark":
                    ...
                    break;
                default:
                    localStorage.getItem("data-bs-theme") && "dark" == localStorage.getItem("data-bs-theme")
                        ? (localStorage.setItem("data-bs-theme", "dark"), document.documentElement.setAttribute("data-bs-theme", "dark"), T("data-bs-theme", "dark"))
                        : (localStorage.setItem("data-bs-theme", "light"), document.documentElement.setAttribute("data-bs-theme", "light"), T("data-bs-theme", "light"));
            }
            switch (e["data-layout-width"]) {
                ...
                default:
                    "boxed" == localStorage.getItem("data-layout-width")
                        ? (localStorage.setItem("data-layout-width", "boxed"), document.documentElement.setAttribute("data-layout-width", "boxed"), T("data-layout-width", "boxed"))
                        : (localStorage.setItem("data-layout-width", "fluid"), document.documentElement.setAttribute("data-layout-width", "fluid"), T("data-layout-width", "fluid"));
            }
            switch (e["data-sidebar"]) {
                ...
                case "gradient-4":
                    ...
                    break;
                default:
                    localStorage.getItem("data-sidebar") && "light" == localStorage.getItem("data-sidebar")
                        ? (localStorage.setItem("data-sidebar", "light"), T("data-sidebar", "light"), document.documentElement.setAttribute("data-sidebar", "light"))
                        : "dark" == localStorage.getItem("data-sidebar")
                            ? (localStorage.setItem("data-sidebar", "dark"), T("data-sidebar", "dark"), document.documentElement.setAttribute("data-sidebar", "dark"))
                            : "gradient" == localStorage.getItem("data-sidebar")
                                ? (localStorage.setItem("data-sidebar", "gradient"), T("data-sidebar", "gradient"), document.documentElement.setAttribute("data-sidebar", "gradient"))
                                : "gradient-2" == localStorage.getItem("data-sidebar")
                                    ? (localStorage.setItem("data-sidebar", "gradient-2"), T("data-sidebar", "gradient-2"), document.documentElement.setAttribute("data-sidebar", "gradient-2"))
                                    : "gradient-3" == localStorage.getItem("data-sidebar")
                                        ? (localStorage.setItem("data-sidebar", "gradient-3"), T("data-sidebar", "gradient-3"), document.documentElement.setAttribute("data-sidebar", "gradient-3"))
                                        : "gradient-4" == localStorage.getItem("data-sidebar") &&
                                        (localStorage.setItem("data-sidebar", "gradient-4"), T("data-sidebar", "gradient-4"), document.documentElement.setAttribute("data-sidebar", "gradient-4"));
            }
            switch (e["data-sidebar-image"]) {
                ...
                case "img-4":
                    ...
                    break;
                default:
                    localStorage.getItem("data-sidebar-image") && "none" == localStorage.getItem("data-sidebar-image")
                        ? (localStorage.setItem("data-sidebar-image", "none"), T("data-sidebar-image", "none"), document.documentElement.setAttribute("data-sidebar-image", "none"))
                        : "img-1" == localStorage.getItem("data-sidebar-image")
                            ? (localStorage.setItem("data-sidebar-image", "img-1"), T("data-sidebar-image", "img-1"), document.documentElement.setAttribute("data-sidebar-image", "img-2"))
                            : "img-2" == localStorage.getItem("data-sidebar-image")
                                ? (localStorage.setItem("data-sidebar-image", "img-2"), T("data-sidebar-image", "img-2"), document.documentElement.setAttribute("data-sidebar-image", "img-2"))
                                : "img-3" == localStorage.getItem("data-sidebar-image")
                                    ? (localStorage.setItem("data-sidebar-image", "img-3"), T("data-sidebar-image", "img-3"), document.documentElement.setAttribute("data-sidebar-image", "img-3"))
                                    : "img-4" == localStorage.getItem("data-sidebar-image") &&
                                    (localStorage.setItem("data-sidebar-image", "img-4"), T("data-sidebar-image", "img-4"), document.documentElement.setAttribute("data-sidebar-image", "img-4"));
            }
            switch (e["data-layout-position"]) {
                ...
                case "scrollable":
                    ...
                    break;
                default:
                    localStorage.getItem("data-layout-position") && "scrollable" == localStorage.getItem("data-layout-position")
                        ? (T("data-layout-position", "scrollable"), localStorage.setItem("data-layout-position", "scrollable"), document.documentElement.setAttribute("data-layout-position", "scrollable"))
                        : (T("data-layout-position", "fixed"), localStorage.setItem("data-layout-position", "fixed"), document.documentElement.setAttribute("data-layout-position", "fixed"));
            }
            switch (e["data-preloader"]) {
                ...
                default:
                    var t;
                    localStorage.getItem("data-preloader") && "disable" == localStorage.getItem("data-preloader")
                        ? (T("data-preloader", "disable"), localStorage.setItem("data-preloader", "disable"), document.documentElement.setAttribute("data-preloader", "disable"))
            ...
            switch (e["data-body-image"]) {
                ...
                case "none":
                    ...
                    break;
                default:
                    localStorage.getItem("data-body-image") && "img-1" == localStorage.getItem("data-body-image")
                        ...
                        : "img-2" == localStorage.getItem("data-body-image")
                            ? (localStorage.setItem("data-body-image", "img-2"), T("data-body-image", "img-2"), document.documentElement.setAttribute("data-body-image", "img-2"))
                            : "img-3" == localStorage.getItem("data-body-image")
                                ? (localStorage.setItem("data-body-image", "img-3"), T("data-body-image", "img-3"), document.documentElement.setAttribute("data-body-image", "img-3"))
                                : "none" == localStorage.getItem("data-body-image") && (localStorage.setItem("data-body-image", "none"), T("data-body-image", "none"), document.documentElement.setAttribute("data-body-image", "none"));
            }
        }
    }
    function p() {
                ...
                a.addEventListener("change", function () {
                    document.documentElement.setAttribute(n, a.value),
                        ...
                        "data-layout-width" == n && "boxed" == a.value
                            ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), localStorage.setItem("data-sidebar-size", "sm-hover"), (document.getElementById("sidebar-size-small-hover").checked = !0))
                            : "data-layout-width" == n &&
                            "fluid" == a.value &&
                            (document.documentElement.setAttribute("data-sidebar-size", "lg"), localStorage.setItem("data-sidebar-size", "lg"), (document.getElementById("sidebar-size-default").checked = !0)),
                        "data-layout" == n &&
                        ("vertical" == a.value
                    ...
                    "semibox" == document.documentElement.getAttribute("data-layout") &&
                        ("hidden" == document.documentElement.getAttribute("data-sidebar-visibility")
                            ...
                            : (document.documentElement.setAttribute("data-sidebar", localStorage.getItem("data-sidebar")),
                                document.documentElement.setAttribute("data-sidebar-image", localStorage.getItem("data-sidebar-image")),
                                document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size")))),
    ...
    function C(e, t, a, n) {
        ...
        localStorage.setItem("data-sidebar",t)
        localStorage.setItem("data-bs-theme",t)
    }
    function N() {
    ...
    localStorage.getItem("defaultAttribute")
        ? (((f = {})["data-layout"] = localStorage.getItem("data-layout")),
            (f["data-sidebar-size"] = localStorage.getItem("data-sidebar-size")),
            (f["data-bs-theme"] = localStorage.getItem("data-bs-theme")),
            (f["data-layout-width"] = localStorage.getItem("data-layout-width")),
            (f["data-sidebar"] = localStorage.getItem("data-sidebar")),
            (f["data-sidebar-image"] = localStorage.getItem("data-sidebar-image")),
            (f["data-layout-position"] = localStorage.getItem("data-layout-position")),
            (f["data-layout-style"] = localStorage.getItem("data-layout-style")),
            (f["data-topbar"] = localStorage.getItem("data-topbar")),
            (f["data-preloader"] = localStorage.getItem("data-preloader")),
            (f["data-body-image"] = localStorage.getItem("data-body-image")),
            e(f))
        : ((L = document.documentElement.attributes),
            (f = {}),
            Array.from(L).forEach(function (e) {
                var t;
                e && e.nodeName && "undefined" != e.nodeName && ((t = e.nodeName), (f[t] = e.nodeValue), localStorage.setItem(t, e.nodeValue));
            }),
            localStorage.setItem("defaultAttribute", JSON.stringify(f)),
            e(f),
